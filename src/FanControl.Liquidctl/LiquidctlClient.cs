...
namespace FanControl.LiquidCtl
{
    public sealed class LiquidctlClient(IPluginLogger logger) : IDisposable
    {
        ...
        private readonly string _exePath = Path.Combine(Path.GetDirectoryName(typeof(LiquidctlClient).Assembly.Location) ?? string.Empty, "liquidctl_server", "liquidctl_server.exe");
